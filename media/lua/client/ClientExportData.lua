...
local function SendPlayerData()
    ...
    local playerData = {
        ...
        boredom = safeGet("boredom", function() return player:getStats():getBoredom() end),
				panic = safeGet("unhappiness", function() return player:getStats():getPanic() end),
				stress = safeGet("unhappiness", function() return player:getStats():getStress() end),
        weight = safeGet("unhappiness", function() return player:getNutrition():getWeight() end),
				calories = safeGet("unhappiness", function() return player:getNutrition():getCalories() end),
				carbs = safeGet("unhappiness", function() return player:getNutrition():getCarbohydrates() end),
				lipids = safeGet("unhappiness", function() return player:getNutrition():getLipids() end),
				proteins = safeGet("unhappiness", function() return player:getNutrition():getProteins() end),
				x = safeGet("unhappiness", function() return player:getX() end),
				y = safeGet("unhappiness", function() return player:getY() end),
				z = safeGet("unhappiness", function() return player:getZ() end),
				direction = safeGet("unhappiness", function() return player:getDir() end),
				bodyDamage = safeGet("unhappiness", function() return player:getBodyDamage():getOverallBodyHealth() end),
				temperature = safeGet("unhappiness", function() return player:getBodyDamage():getTemperature() end),
				wetness = safeGet("unhappiness", function() return player:getBodyDamage():getWetness() end),
				fatigueLevel = safeGet("unhappiness", function() return player:getStats():getFatigueLevel() end),
				infectionLevel = safeGet("unhappiness", function() return player:getBodyDamage():getInfectionLevel() end),
        skills = {}
    }
